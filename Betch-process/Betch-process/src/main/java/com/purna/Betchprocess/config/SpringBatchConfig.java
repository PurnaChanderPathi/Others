...
import com.purna.Betchprocess.repository.CustomerRepository;
...
public class SpringBatchConfig {
    ...
    public Step step1(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
        ...
        return new StepBuilder("csv-step", jobRepository).<Customer,Customer>
    ...
    {
        return new JobBuilder("Important Customer",jobRepository)
